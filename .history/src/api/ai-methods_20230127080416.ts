...
export const imagine = async (conn: WASocket, message: proto.IWebMessageInfo, channel:  prompt: string) => {
    let channelData = await conn.groupMetadata("120363048224499981@g.us")
