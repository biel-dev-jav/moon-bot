...
export const generateWaitSentence = async (nome: string, prompt: string) => {
    const response = await openai.createCompletion({
        ...
        prompt: `Gere uma frase de espera unica e super legal, gentil e com muita emoção
nome: João
...
frase: Aguarde MoonDev, estou criando uma figura misteriosa que desenha sombras ao andar pela sua obra de arte digital 🎨 por Da Vinci no estilo escuro e surreais.
