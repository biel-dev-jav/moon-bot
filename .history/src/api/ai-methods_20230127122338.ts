...
export const promptToCommand = async (nome: string, prompt: string, prefix: string) => {
    const response = await openai.createCompletion({
        model: "text-davinci-003",
        prompt: `Converta os prompts para um dos comandos disponiveis
comandos permitidos: play
comando base: ${prefix}comando [args]
exemplo: ${prefix}play uma musica

prompt: toque a musica Macallan de Dj GM
comando: ${prefix}play Macallan
