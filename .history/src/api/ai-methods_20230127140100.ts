...
export const promptToCommand = async (prompt: string, prefix: string) => {
    const response = await openai.createCompletion({
        ...
        prompt: `Converta os prompts para um comando

prompt: "bani o @77880234446 pra mim
comando: *ban @77880234446

prompt: "converta essa imagem em uma figurinha"
comando: *f

prompt: "toque a musica Coração Gelado"
comando: *play coração gelado

prompt: "Como faz arroz?"
comando: *play como fazer um arroz delicioso

prompt: "Nossa preciso estudar inglês"
comando: *play Aulas de inglês
