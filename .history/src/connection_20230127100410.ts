...
import { generateSacarsticSentence, generateWaitSentence, imagine, isViolating, moreContext } from './api/ai-methods';
        ...
        messages.forEach(async message => {
            ...
            switch (command) {
                ...
                case 'wait': {
                    ...
                    prompt = (await generateWaitSentence(message.pushName!))!
